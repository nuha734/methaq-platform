تم عفعوف. غيّرت النص فقط ورجعته للنص الأصلي، وكل شيء ثاني في الكود كما هو.
...
st.markdown(
    ...
    <div class="main-title">
        ...
        <p>منصة ذكية للتدقيق والامتثال للأنظمة السعودية</p>
    </div>
    """,
    unsafe_allow_html=True
)
st.markdown(
    ...
    <div class="hero-box">
        <div class="hero-text">
            تساعد منصة ميثاق على فحص سياسات الخصوصية وبعض عناصر المتجر
            واستخراج المؤشرات والأدلة والتوصيات بشكل مبدئي.
        </div>
        <br>
        <b>⚠️ تنبيه:</b>
        النتائج تمثل مؤشر فحص مبدئي لأغراض تجريبية،
...
with tab1:
    st.markdown(
        '<div class="section-title">🔎 فحص المتجر الإلكتروني</div>',
        unsafe_allow_html=True
    )
    ...
    if st.button(
        ...
        if not store_url.strip():
            ...
            if not html:
                ...
                st.markdown(
                    '<div class="section-title">📊 ملخص الفحص</div>',
                    unsafe_allow_html=True
                )
                ...
                st.markdown(
                    '<div class="section-title">📄 نتائج فحص سياسة الخصوصية</div>',
                    unsafe_allow_html=True
                )
